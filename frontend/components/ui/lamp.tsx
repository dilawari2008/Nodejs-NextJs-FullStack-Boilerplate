    ...
    <LampContainer>
      ...
      >
        <div className="flex flex-col w-full gap-4 justify-center items-center">
          ...
          <div className="flex text-sm text-white tracking-wider gap-10">
            <Link href="/signup" className="hover:underline decoration-white">Sign Up</Link>
            <p> | </p>
            <Link href="/login" className="hover:underline decoration-white">
              Login
            </Link>
          </div>
        </div>
